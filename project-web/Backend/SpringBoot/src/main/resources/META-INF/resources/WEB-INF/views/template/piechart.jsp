            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item active has-sub"><a href="#"
                                                               class='sidebar-link'> <i data-feather="triangle"
                                                                                        width="20"></i>
                        <span>Thống kê</span>
                    </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="#"><i data-feather="user"></i>
                                ...
                                data-feather="mail"></i> Messages</a> <a class="dropdown-item"
                                                                         href="#"><i data-feather="settings"></i>
                            Settings</a>
                            ...
                            <div style="display: flex">
                                ...
                                <div>
                                    ...
                                    <table>
                                        <tr>
                                            <td colspan="2"><a
                                                    href="/admin/charts/piechart-duration-learned">
                                                <button
                                        ...
                                        <tr>
                                            <td colspan="2"><a href="/admin/charts/piechart">
                                                <button
                                                        type="button">Tỉ lệ thể loại khóa học
                                                </button>
                                            </a></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><a
                                                    href="/admin/charts/piechart-category-money">
                                                <button
                                                        type="button">Doanh thu theo thể loại khóa học
                                                </button>
                                            </a></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><a href="http://localhost:3000">
                                                <button
                                                        type="button">Trờ về
                                                </button>
                                            </a></td>
