    ...
    <table>
        ...
        <tr>
            ...
            <td><form:input id="category" path="category.name"
                ...
                <form:input type="hidden" path="categoryId" id="category-hidden"/></td>
        </tr>
                                    ...
                                    <div id="part-index-${status.index}-lessons"
                                        ...
                                        <c:forEach var="lesson" items="${part.lessons}"
                                            ...
                                            <div
                                                ...
                                                <form:input
                                                        id="part-index-${status.index}-lesson-index-${statusLesson.index}-video-hidden"
                                                        type="hidden"
                                                        path="parts[${status.index}].lessons[${statusLesson.index}].videoId"/>
                                                <form:input
                                                        id="part-index-${status.index}-lesson-index-${statusLesson.index}-video"
                                                        list="videos"
