...
<div style="display: flex">
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                <td colspan="2"><a href="/admin/charts/piechart-duration-learned">
                    <button type="button">Tỉ lệ thời gian học của từng thể loại khóa học</button>
                </a></td>
            </tr>
            <tr>
                <td colspan="2"><a href="/admin/charts/piechart">
                    <button type="button">Tỉ lệ thể loại khóa học</button>
                </a></td>
            </tr>
            <tr>
                <td colspan="2"><a href="/admin/charts/piechart-category-money">
                    <button type="button">Doanh thu theo thể loại khóa học</button>
                </a></td>
            </tr>
            <tr>
                <td colspan="2"><a href="/admin/charts">
                    <button type="button">Trờ về</button>
                </a></td>
            </tr>
        </table>
    </div>
