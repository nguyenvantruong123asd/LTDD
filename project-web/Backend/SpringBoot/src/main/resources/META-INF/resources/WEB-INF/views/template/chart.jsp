                ...
                <ul class="menu">
                    ...
                    <li class="sidebar-item active has-sub"><a href="#"
                        ...
                        <ul class="submenu active">
                            ...
                            <li><a href="http://localhost:25001/admin/charts/chart-money-categories">Biểu đồ cột</a>
                            </li>
                            ...
                            <div style="display: flex">
                                ...
                                <div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2"><a
                                                    href="/admin/charts/chart-money-categories">
                                                <button
                                        ...
                                        <tr>
                                            <td colspan="2"><a
                                                    href="/admin/charts/chart-money-month">
                                                <button
