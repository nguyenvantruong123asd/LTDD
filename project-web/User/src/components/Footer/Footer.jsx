        ...
        <div className="footer">
                ...
                <div className="card">
                    ...
                    <div className="social">
                        <ul>
                            ...
                            <li className="red">
                                <a href="mailto:18130263@st.hcmuaf.edu.vn">
                                    <i className="fas fa-envelope"></i>
                                </a>
                            </li>
                            <li className="green">
                                <a href="tel:+84358317952">
                ...
                <div className="right">
                    <a href="tel:+0375094399" className="phone">
                        ...
                        <div className="phone-right">
                            <div className="title">0358317952</div>
            ...
            <div className="bottom">
                <div className="copyright">
                    Copyright @2022. Đây là sản phẩm học tập
                </div>
                <div className="social">
                    <ul>
                        <li>
                            <a
                                href="http://Fb.com/truong07032000"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <i className="fab fa-facebook blue"></i>
                                <span>Fb.com/truong07032000</span>
                            </a>
                        </li>
                        <li>
                            <a
