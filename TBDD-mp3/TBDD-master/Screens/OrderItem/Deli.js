      ...
      <View
        ...
        <View style={styles.orderRow}>
          <View
            ...
            <Text style={{color: '#9A9A9A',fontFamily: 'Quicksand-SemiBold', fontWeight: 'bold'}}>
              Tên mặt hàng:
            </Text>
          ...
          <View
            ...
            <Text style={{color: '#343D46'}}>{data.time}</Text>
          </View>
          <View
            style={{
              flexDirection: 'row',
    ...
    return (
      <View style={wrapper}>
        <View>
          ...
          <Text style={styles.headerTitle1}>Đang giao</Text>
        </View>
        <View style={body}>
